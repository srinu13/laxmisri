...
import dct.com.controller.ReadingPcapJson;
import dct.com.model.PCAPList;


@Service
public class OfflineAnalysisServiceImpl {

	private static final int COUNT = 1000;
	private static final String PCAP_FILE_KEY = OfflineAnalysisServiceImpl.class.getName() + ".pcapFile";
	...
	public JSONObject pcapPacket(MultipartFile file) throws IOException {
		...
		try {
			rootJson = ReadingPcapJson.readings1apMessage();
